...
class RmiServerSessionRepositoryImpl():
    ...
    def add_rmi_server_session(self, rmi_server_session:RmiServerSessionModel) -> RmiServerSessionModel:
        self.session.add(rmi_server_session)
        self.session.commit()
    ...
    def get_rmi_server_session(self,rmi_server_session:RmiServerSessionModel):
        server_session = self.session.query(RmiServerSessionModel).filter(RmiServerSessionModel.id_rmi_server_session == rmi_server_session.id_rmi_server_session).first()
